...
const VideoShapeSVG = forwardRef<SVGSVGElement, IconProps>(({ className, ...props }, ref) => (
  <svg ref={ref} {...props} className={className} fill="none" height="563" viewBox="0 0 1440 563" width="1440" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
    ...
    <linearGradient id="c" gradientUnits="userSpaceOnUse" x1="-18.9868" x2="202.082" xlinkHref="#b" y1="176.5" y2="533.363" />
    <linearGradient id="d" gradientUnits="userSpaceOnUse" x1="276.308" x2="430.232" xlinkHref="#b" y1="609" y2="334.49" />
...
VideoShapeSVG.displayName = "VideoShapeSVG";
export default VideoShapeSVG;

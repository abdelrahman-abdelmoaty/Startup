      ...
      <div className="container grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-10">
        <div className="lg:col-span-2">
          <div className=" max-w-sm flex flex-col gap-8">
            <a href="/" className="">
              <Image width="100" height="100" src={logoBlack.src} alt={"logo"} className="w-40 h-auto block dark:hidden" />
              <Image width="100" height="100" src={logoWhite.src} alt={"logo"} className="w-40 h-auto hidden dark:block" />
            </a>
            <p className="font-medium text-gray-400">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer lobortis.</p>

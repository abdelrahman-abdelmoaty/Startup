    ...
    <section className="relative bg-background dark:bg-backgroundDark pt-32 pb-20 lg:pt-48 lg:pb-44">
      ...
      <div className="h-full container flex items-center justify-center text-center flex-col z-10 relative leading-snug">
        ...
        <Paragraph>
          ...
          websites comes with all the essential pages, components, and sections
          you need to launch a complete business website, built-with Next 13.x
          and Tailwind CSS.
        </Paragraph>
        <div className="mt-12 flex flex-col sm:flex-row gap-5 items-center">
          <ContainedLink
            href="/pricing"
            className="hover:shadow-none hover:opacity-80 py-4 px-6 w-fit"
          >
            🔥 Get Pro
          </ContainedLink>
          <ContainedLink
            href="https://github.com/abdelrahman-abdelmoaty/Startup"
            className="hover:shadow-none hover:opacity-100 dark:hover:opacity-100 dark:hover:bg-gray-500 py-4 text-text dark:text-textDark bg-gray-300 hover:bg-gray-400 dark:bg-[#535771]"
          >
            Star on Github
          </ContainedLink>
        </div>

    ...
    <div>
      ...
      <section className="bg-background dark:bg-backgroundDark py-24">
        ...
        <div className="flex items-center justify-center gap-3 mt-10">
          <div className="px-4 py-2 bg-gray-100 dark:bg-dropMenuDark rounded-md text-gray-600 dark:text-gray-200 text-sm hover:bg-foreground transition hover:text-white cursor-pointer">
            Prev
          </div>
          <div className="px-4 py-2 bg-gray-100 dark:bg-dropMenuDark rounded-md text-gray-600 dark:text-gray-200 text-sm hover:bg-foreground transition hover:text-white cursor-pointer">
            1

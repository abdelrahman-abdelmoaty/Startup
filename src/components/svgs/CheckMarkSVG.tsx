...
const CheckMarkSVG = forwardRef<SVGSVGElement, IconProps>(({ className, ...props }, ref) => (
  <svg ref={ref} {...props} className={className + " fill-current"} width="8" height="6" viewBox="0 0 8 6">

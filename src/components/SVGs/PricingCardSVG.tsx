...
const PricingCardSVG = forwardRef<SVGSVGElement, IconProps>(({ className, ...props }, ref) => (
  <svg ref={ref} {...props} className={className} width="179" height="158" viewBox="0 0 179 158" fill="none" xmlns="http://www.w3.org/2000/svg">
...
PricingCardSVG.displayName = "PricingCardSVG";
export default PricingCardSVG;

...
const LeftSubscribeCardSVG = forwardRef<SVGSVGElement, IconProps>(({ className, ...props }, ref) => (
  <svg ref={ref} {...props} className={className} width="370" height="596" viewBox="0 0 370 596" fill="none" xmlns="http://www.w3.org/2000/svg">
    <mask type="alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="370" height="596">
...
LeftSubscribeCardSVG.displayName = "LeftSubscribeCardSVG";
export default LeftSubscribeCardSVG;

...
export default function Home() {
  return (
    <main>
      ...
      <Features />
      <Video />
      <section className="flex items-center justify-center bg-background dark:bg-backgroundDark pt-16">
        <div className="bg-secondaryBackgroundDark py-14 container flex items-center justify-center gap-10 flex-wrap">
          <a href="/">
            <img src={graygrids.src} alt="graygrids" className="h-12 w-56" />
          </a>
          <a href="/">
            <img src={tailadmin.src} alt="tailadmin" className="h-12 w-56" />
          </a>
          <a href="/">
            <img src={lineicons.src} alt="lineicons" className="h-12 w-56" />
          </a>
          <a href="/">
            <img src={uideck.src} alt="uideck" className="h-12 w-56" />
          </a>
          <a href="/">
            <img src={tailgrids.src} alt="tailgrids" className="h-12 w-56" />
          </a>
        </div>
      </section>
      ...
      <section className="py-24 bg-background dark:bg-backgroundDark">
        <div className="container flex flex-col lg:items-center lg:flex-row gap-10">
          <div className="lg:w-1/2 mx-auto">
            <img src={aboutImg2.src} alt="aboutImg2" />
          </div>

...
export default function Footer() {
  return (
    <footer className="bg-secondaryBackground dark:bg-secondaryBackgroundDark py-24 relative">
      <div className="container grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-10">
        <div className="lg:col-span-2">
          <div className=" max-w-sm flex flex-col gap-8">
            ...
            <div className="flex gap-5 items-center">
              <a href="https://facebook.com/startup" aria-label="Facebook" className="hover:text-foreground transition">
              ...
              <a href="https://twitter.com/startup" aria-label="Twitter" className="hover:text-foreground transition">
              ...
              <a href="https://youtube.com/startup" aria-label="YouTube" className="hover:text-foreground transition">
              ...
              <a href="https://linkedin.com/company/startup" aria-label="LinkedIn" className="hover:text-foreground transition">
      ...
      <FooterSVG className="absolute left-0 bottom-0" />
    </footer>
  );
}
